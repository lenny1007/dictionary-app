...
type YahooSearchScreenNavigationProp = NavigationProp<RootStackParamList>;

const YahooSearchScreen: React.FC = () => {
  const navigation = useNavigation<YahooSearchScreenNavigationProp>();
  ...
  const handleSearch = async (text: string) => {
    ...
    setLoading(true);
    try {
      const searchService = YahooDictionaryService.getInstance();
    ...
    <View style={styles.container}>
      <View style={styles.searchContainer}>
        ...
        <TextInput
          ...
          placeholder="Search in Yahoo Dictionary..."
          value={query}
...
export default YahooSearchScreen; 